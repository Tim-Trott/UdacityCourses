...
func digitsOnly(_ price: String) -> Bool {
    
    for char in price.unicodeScalars {
...
func clean(_ dirtyWords: [String]) -> [String] {
    var cleanWords = [String]()
    for var word in dirtyWords {
...
class MovieArchive {
    func filterByDirector(movies: Dictionary<String,String>, directorName: String) -> [String] {
...
var ma = MovieArchive()
ma.filterByDirector(movies: movies, directorName: "Christopher Nolan")
//: [Next](@next)
