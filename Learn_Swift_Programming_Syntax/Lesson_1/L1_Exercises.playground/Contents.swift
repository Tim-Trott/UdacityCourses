...
let yourSentence = "The \(nounArray[3]) broke the \(nounArray[6])"
let yourSillySentence = "\(nounArray[index1]) jumped on the train with the \(nounArray[index2])"
//: ### Exercise 2
...
if(word.contains("tuna")) {
    print("It does contain tuna")
} else {
    print("No it does not contain tuna")
}
//: ### Exercise 6
...
var dollars = (numOfPennies-cents)/100
var moneyString = "$\(dollars).\(cents)"
//desired output = "$5.67"
//: # Let or Var?
import UIKit
import Foundation
