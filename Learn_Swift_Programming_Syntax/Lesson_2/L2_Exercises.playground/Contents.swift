...
if let director = moviesDict[movie] {
    ...
    print("No known director for the movie \(movie)")
}
...
if let artist = paintingDict[painting] {
    ...
    print("No known artist for painting \(painting)")
}
...
if let parent = childViewController.parent {
    print("There is a parent view controller here")
} else {
    print("No parent view controller here")
}
